...
class _HomePageState extends State<HomePage>
  ...
  List<VideoPlayerController> videoPlayerController_list=[];


  videoPlayerList(){
    for(String str in mainvideo_list){
      videoPlayerController_list.add(loadController(str));
    }
    videoPlayerController_list[0].play();
  }

  VideoPlayerController loadController(var str) {
    return  VideoPlayerController.network(str)
      ..initialize()
      ..setLooping(true);
  }
  ...
  changeVideo(index) async {
   if(current_page<index){
     videoPlayerController_list[index-1].pause();
     videoPlayerController_list[index].play();
     current_page=index;
  ...
  @override
  void initState() {
    mainvideo_list=MainScreen.list;
    videoPlayerList();
        ...
        return Scaffold(
          ...
          children: <Widget>[
            PageView.builder(
              ...
              itemCount: videoPlayerController_list.length,
              itemBuilder: (BuildContext context, int index) {
                return Stack(
                  children: <Widget>[
                    ...
                    //       )
                    //     : Container(),
                    VideoPlayer(videoPlayerController_list[index]),
                    _isPlaying == false
                        ? Align(
